# -*- coding: utf-8 -*-
"""
Created on Wed Feb  9 16:52:19 2022
...
for i in range(len(points_x)):
    for j in range(len(points_y)):
        ...
        y0 = points_y[j] #y coordinate initial position

        
 #       delta = Ohm**2 *x0**2 - 2*(0.5*px0**2 + potential(x0,y0,0) - H0) 
        delta = Ohm**2 *y0**2 - 2*( potential(x0,y0,0) - H0) 
